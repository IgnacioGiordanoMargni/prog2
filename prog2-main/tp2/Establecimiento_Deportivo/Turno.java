...
public Turno(LocalDateTime horario, Usuarios usuario, Canchas cancha) {
       this.horario = horario;
       this.usuario = usuario;
       this.cancha = cancha;
}

public Turno(LocalDateTime horario, Usuarios usuario, String tipo) {
       this.horario = horario;
       this.usuario = usuario;
       this.cancha=new Canchas(tipo);
}
